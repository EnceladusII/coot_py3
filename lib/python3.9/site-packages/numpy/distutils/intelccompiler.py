...
class IntelCCompiler(UnixCCompiler):
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        if platform.system() == 'Darwin':
            shared_flag = '-dynamiclib -Wl,-undefined,dynamic_lookup -Wl,-headerpad_max_install_names '
        else:
            shared_flag = '-shared'
        self.set_executables(compiler=compiler,
                             ...
                             archiver='xiar' + ' cru',
                             linker_exe=compiler + ' -shared-intel ' + os.environ.get('LDFLAGS'),
                             linker_so=compiler + ' -shared-intel  ' + shared_flag + os.environ.get('LDFLAGS') )
